...
#    Author: Ruksana P (odoo@cybrosys.info)
#
...
class ExpenseWizard(models.TransientModel):
    """This wizard is used for creating expense records.
    It allows users to specify the service name, the employee names associated
    with the record, and the total amount for the record.
    """
    _name = 'expense.request'
    _description = "Wizard for Creating Expense Request"
    ...
    total_amount = fields.Float(
        string="Total Amount", help="The total amount for this record.")
